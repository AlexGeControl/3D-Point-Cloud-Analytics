...
def describe(point_cloud, search_tree, keypoint_id, search_params, B):
    """
    ...
    # SPFH from neighbors:
    X = np.asarray(
        [get_spfh(point_cloud, search_tree, i, search_params, B) for i in idx_neighbors]
    )
    ...
    # query point spfh:
    spfh_query = get_spfh(point_cloud, search_tree, keypoint_id, search_params, B)
